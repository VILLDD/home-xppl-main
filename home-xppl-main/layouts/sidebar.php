            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarApps">
                        <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <div class="collapse menu-dropdown" id="sidebaremailTemplates">
                                                <ul class="nav nav-sm flex-column">
                                                    ...
                                                    <li class="nav-item">
                                                        <a href="apps-email-ecommerce.php" class="nav-link" data-key="t-ecommerce-action">
                                                            <?= $lang['t-ecommerce-action'] ?> </a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                            ...
                            <li class="nav-item">
                                <a href="#sidebarCrypto" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarCrypto"><?= $lang['t-crypto'] ?>
                                </a>
                            ...
                            <li class="nav-item">
                                <a href="#sidebarInvoices" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarInvoices"><?= $lang['t-invoices'] ?>
                                </a>
                            ...
                            <li class="nav-item">
                                <a href="#sidebarTickets" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarTickets"><?= $lang['t-supprt-tickets'] ?>
                                </a>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarjobs">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="apps-job-statistics.php" class="nav-link" data-key="t-statistics"> <?= $lang['t-statistics'] ?> </a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a href="apps-job-new.php" class="nav-link" data-key="t-new-job"> <?= $lang['t-new-job'] ?>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarLayouts" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarLayouts">
                        <i class="ri-layout-3-line"></i> <span><?= $lang['t-layouts'] ?></span><span class="badge badge-pill bg-danger" data-key="t-hot"><?= $lang['t-hot'] ?></span></span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarLayouts">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="layouts-horizontal.php" target="_blank" class="nav-link"><?= $lang['t-horizontal'] ?></a>
                            </li>
                            <li class="nav-item">
                                <a href="layouts-detached.php" target="_blank" class="nav-link"><?= $lang['t-detached'] ?></a>
                            </li>
                            <li class="nav-item">
                                <a href="layouts-two-column.php" target="_blank" class="nav-link"><?= $lang['t-two-column'] ?></a>
                            </li>
                            <li class="nav-item">
                                <a href="layouts-vertical-hovered.php" target="_blank" class="nav-link"><?= $lang['t-hovered'] ?></a>
                            </li>
                        </ul>
                    </div>
                </li> <!-- end Dashboard Menu -->
                ...
                <li class="nav-item"> <a class="nav-link menu-link" href="#sidebarLanding" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarLanding">
                        <i class="ri-rocket-line"></i> <span data-key="t-landing"><?= $lang['t-landing'] ?></span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarLanding">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="landing.php" class="nav-link" data-key="t-one-page"> <?= $lang['t-one-page'] ?>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="nft-landing.php" class="nav-link" data-key="t-nft-landing">
                                    <?= $lang['t-nft-landing'] ?></a>
                            </li>
                            <li class="nav-item">
                                <a href="job-landing.php" class="nav-link"><span data-key="t-job"><?= $lang['t-job'] ?></span> <span class="badge badge-pill bg-success" data-key="t-new"><?= $lang['t-nft-new'] ?></span></a>
                            </li>
                        </ul>
                    </div>
                </li>
